<%@ page import="com.greencloud.gateway.scriptManage.FilterInfo" %>
<%@ page import="com.greencloud.gateway.scriptManage.GatewayFilterDAOFactory" %>
<%@ page import="com.greencloud.gateway.scriptManage.IGatewayFilterDAO" %>
<%@ page import="com.greencloud.gateway.util.AdminFilterUtil" %>
...
<%
    ...
    IGatewayFilterDAO scriptDAO = null;
    try {
        scriptDAO = GatewayFilterDAOFactory.getGatewayFilterDAO();
    } catch (Exception e) {
...
<table border="1">
    ...
    <%
        for (String filterID : filterIds) {
            filters = scriptDAO.getGatewayFilters(filterID);
            for (FilterInfo filter : filters) {
    %>
    <tr>
        <td><%=filter.getFilterName()%>
