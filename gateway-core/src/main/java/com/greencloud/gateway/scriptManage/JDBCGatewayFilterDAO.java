...
public class JDBCGatewayFilterDAO implements IGatewayFilterDAO {
	private static final Logger logger = LoggerFactory.getLogger(JDBCGatewayFilterDAO.class);
	private String filterTable;
	private HikariDataSource dataSource;
	private String applicationName;
	private String SQL;

	public JDBCGatewayFilterDAO(String filterTable, HikariDataSource dataSource, String applicationName) {
