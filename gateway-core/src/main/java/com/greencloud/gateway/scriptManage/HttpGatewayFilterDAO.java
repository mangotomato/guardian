...
public class HttpGatewayFilterDAO implements IGatewayFilterDAO {

    private DynamicStringProperty filterRepository = DynamicPropertyFactory.getInstance().getStringProperty(GatewayConstants.GATEWAY_FILTER_REPO, "http://localhost:8080/filters");
    private String applicationName;
    private CloseableHttpClient httpclient;

    public HttpGatewayFilterDAO(String applicationName) {
