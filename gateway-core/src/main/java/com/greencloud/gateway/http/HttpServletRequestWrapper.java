...
public class HttpServletRequestWrapper extends javax.servlet.http.HttpServletRequestWrapper {
    ...
    private void parseRequest() throws IOException {
        ...
        Map<String, List<String>> query = HTTPRequestUtil.getInstance().getQueryParams();
        if (query != null) {
    ...
    private boolean shouldBufferBody() {
        ...
        if (LOG.isDebugEnabled()) {
            ...
            LOG.debug("Transfer-Encoding = " + String.valueOf(req.getHeader(HttpHeader.TRANSFER_ENCODING)));
            LOG.debug("Content-Encoding = " + String.valueOf(req.getHeader(HttpHeader.CONTENT_ENCODING)));
        ...
        if (req.getContentLength() > 0) {
            ...
            final String transferEncoding = req.getHeader(HttpHeader.TRANSFER_ENCODING);
            if (transferEncoding != null && transferEncoding.equals(HttpHeader.CHUNKED)) {
