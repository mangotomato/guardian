...
public class RibbonFilter extends GatewayFilter {
	...
	private IClientConfig buildRequestConfig(String serviceName) {
		...
		clientConfig.setProperty(CommonClientConfigKey.MaxHttpConnectionsPerHost, com.greencloud.gateway.filters.route.RibbonFilter.RibbonPropertyHelper
				.getRibbonMaxHttpConnectionsPerHost(serviceName));
		clientConfig.setProperty(CommonClientConfigKey.MaxTotalHttpConnections, com.greencloud.gateway.filters.route.RibbonFilter.RibbonPropertyHelper
				.getRibbonMaxTotalHttpConnections(serviceName));
		clientConfig.setProperty(CommonClientConfigKey.MaxAutoRetries, com.greencloud.gateway.filters.route.RibbonFilter.RibbonPropertyHelper
				.getRibbonMaxAutoRetries(serviceName));
		clientConfig.setProperty(CommonClientConfigKey.MaxAutoRetriesNextServer, com.greencloud.gateway.filters.route.RibbonFilter.RibbonPropertyHelper
